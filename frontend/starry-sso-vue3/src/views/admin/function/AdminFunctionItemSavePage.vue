  ...
  <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" status-icon>
    <el-row>
      <el-col :offset="4" :span="4">
        <el-text tag="b">功能项编码：</el-text>
      </el-col>
      <el-col :span="12">
        <el-form-item prop="code">
          <el-input name="code" v-model="ruleForm.code" style="width: 300px;" placeholder="请输入功能项编码" clearable/>
        </el-form-item>
      </el-col>
    </el-row>
    ...
    <el-row>
      <el-col :offset="4" :span="4">
        <el-text tag="b">功能项名称：</el-text>
      </el-col>
      <el-col :span="12">
        <el-form-item prop="name">
          <el-input name="name" v-model="ruleForm.name" style="width: 300px;" placeholder="请输入功能项名称" clearable/>
        </el-form-item>
      </el-col>
    </el-row>
    ...
    <el-row>
      <el-col :offset="4" :span="4">
        <el-text tag="b">路径模式：</el-text>
      </el-col>
      <el-col :span="12">
        <el-form-item prop="pattern">
          <el-input name="pattern" v-model="ruleForm.pattern" style="width: 300px;" placeholder="请输入路径模式" clearable/>
        </el-form-item>
      </el-col>
    </el-row>
    ...
    <el-row>
      <el-col :offset="3" :span="5">
        <el-text tag="b">HTTP请求方法：</el-text>
      </el-col>
      <el-col :span="9">
...
// http请求方法类型枚举
const allHttpMethodList = ["GET", "POST", "PUT", "DELETE"]
...
const ruleForm = reactive({
  ...
  httpMethodList: componentParamRef.value.opType === 'createItem' ? [] : selectedRowRef.value.httpMethodList,
...
const rules = reactive({
  code: [
    { required: true, message: '请输入功能项编码', trigger: 'blur', pattern: /\S+/ },
    { min: 1, max: 128, message: '不能超过128字符', trigger: 'blur' },
  ],
  name: [
    { required: true, message: '请输入功能项名称', trigger: 'blur', pattern: /\S+/ },
    { min: 1, max: 255, message: '不能超过255字符', trigger: 'blur' },
  ],
  pattern: [
    { required: true, message: '请输入功能项URL', trigger: 'blur', pattern: /\S+/ },
    { min: 1, max: 255, message: '不能超过255字符', trigger: 'blur' },
  ],
  httpMethodList: [
    { type: 'array', required: true, message: '请选择至少一种HTTP请求方法', trigger: 'change'}
  ],
  seq: [
...
function save(){
  ...
  ruleFormRef.value.validate(valid => {
    if (valid) {
      ...
      HttpApi.post("/api/auth/admin/function/saveItem", ruleForm, config,
          () => {
