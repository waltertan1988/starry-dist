...
public class ExtSyncMcpToolCallbackProvider implements ToolCallbackProvider {
    ...
    public ExtSyncMcpToolCallbackProvider(McpSyncClient mcpClient, McpToolFilter toolFilter) {
    ...
    public ToolCallback[] getToolCallbacks() {
        ...
        return SyncMcpToolCallbackProvider.builder().toolFilter(toolFilter).mcpClients(mcpClient).build().getToolCallbacks();
    }
}
