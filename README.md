...
这是一个采用JDK21、SpringBoot3.5、Spring Security、Spring AI、Docker Compose、Vue3、Element-Plus，含OAuth2单点登录认证的授权服务、可配置菜单和RBAC权限管理、可调用大模型（LLM）、前后端分离部署、核心中间件配置高可用的后台管理平台，具体说明可参看：
